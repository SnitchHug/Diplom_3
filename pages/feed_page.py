...
class FeedPage(BasePage):
    ...
    @allure.step("зафиксировать количество заказов в разделе 'Выполнено за все время'")
    ...
    @allure.step("зафиксировать количество заказов в разделе 'Выполнено за сегодня'")
